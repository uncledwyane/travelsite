<template>
  <div id="post-wrap">
      <div id="post-item" v-for="post in allPosts" :key="post.post_id" @click="showPostview(post)">
          <div class="post-img">
              <img :src="post.post_coverimg ? post.post_coverimg : 'https://s3.ax1x.com/2021/02/24/yLvUfJ.png'" class="post-image">
          </div>
          <div class="post-info">
