<template>
  <div id="push-post-wrap">
      <h2>发表游记</h2>
      <el-input v-model="post_title" placeholder="请输入游记标题..." style="margin: 20px 0; "></el-input>
      <el-input v-model="post_cover" placeholder="请输入游记封面图片路径(可不填，也可通过下方上传按钮上传图片获取地址)..." style="margin-bottom: 20px;"></el-input>
      <el-input
        type="textarea"
        :autosize="{minRows: 9}"
        placeholder="请输入游记内容"
